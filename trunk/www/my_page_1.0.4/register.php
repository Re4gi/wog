<?php require_once("head.php") ?>
 ...
 <div id="page">
	<div id="content">
		...
		{
			$script="INSERT INTO names (login, firstname, surname, birth_date, street, number, city, zip_code, country, phone_num,
			email, icq, prefered_race, prefered_class, password) VALUES ('$d_login','$d_firstname','$d_surname','$d_birth_date',
			'$d_street','$d_number','$d_city','$d_zip_code','$d_country','$d_phone_num','$d_email','$d_icq','$d_prefered_race','$d_prefered_class','$d_pswd')";
